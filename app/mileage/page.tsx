...
export const metadata: Metadata = {
  title: "Mileage",
  description: "Understand mileage deduction rules and how NotaryCentral tracks trips automatically.",
}

export default function MileagePage() {
  const markdownPath = path.join(process.cwd(), "data", "blog", "mileage.md")
