...
export const metadata: Metadata = {
  title: "From Paper to Digital",
  description:
    "Unify past paper records with new electronic entries by uploading scans and making your entire journal searchable.",
}
