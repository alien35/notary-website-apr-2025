...
export const metadata: Metadata = {
  title: "Never Lose Track of Payments Again",
  description:
    "Learn how NotaryCentral's automatic tracking and overdue alerts help notaries get paid on time.",
}

export default function NeverLoseTrackOfPaymentsAgainPage() {
  const markdownPath = path.join(
    process.cwd(),
    "data/blog",
    "never-lose-track-of-payments-again.md"
  )
